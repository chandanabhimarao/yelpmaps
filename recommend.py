...
def group_by_centroid(restaurants, centroids):
    ...
    for restaurant in restaurants:
        ...
        rest_and_cent.append([closest_centroid, restaurant])
    return group_by_first(rest_and_cent)
    # END Question 4
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    feat_r = max(feature_fns, key = lambda x: find_predictor(user, reviewed, x)[1])
    return find_predictor(user, reviewed, feat_r)[0]
    # END Question 8
...
def rate_all(user, restaurants, feature_fns):
    ...
    for restaurant in restaurants:
        ...
        if restaurant in reviewed:
            ...
            dict[name] = predictor(restaurant)
    return dict
    # END Question 9
